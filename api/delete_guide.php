...
try {
    ...
    $stmt = mysqli_prepare($link, "DELETE FROM announcements WHERE content_id = ? AND page_type = 'guide'");
    ...
    if (mysqli_stmt_affected_rows($stmt) === 0) {
        throw new Exception("Guide not found or already deleted.");
    }
